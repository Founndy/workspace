...
4. **Passo em que paramos:** embarque/desembarque delegando aos assentos do `Aviao` (pergunta deixada para ele: o que o `Voo` precisa verificar antes de repassar o passageiro ao `Aviao.adicionarPessoa`?).
